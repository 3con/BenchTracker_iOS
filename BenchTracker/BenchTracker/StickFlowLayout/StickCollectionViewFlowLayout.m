...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    [allItems enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        ...
        if ([attributes.representedElementKind isEqualToString:UICollectionElementKindSectionHeader]) headerAttributes = attributes;
        else [self updateCellAttributes:attributes withSectionHeader:headerAttributes];
    }];
    return allItems;
}
