...
+ (UIColor *)BTSecondaryColor {           //rgb(22,58,171)    //indigo 600 (r-25, g-15)
    switch ([self colorScheme]) {
        case 0: return [UIColor colorWithRed:22/255.0 green:58/255.0 blue:171/255.0 alpha:1];
...
+ (UIColor *)BTTertiaryColor {            //rgb(55,80,200)    //indigo 500 (r-30, g-20)
    switch ([self colorScheme]) {
        case 0: return [UIColor colorWithRed:55/255.0 green:80/255.0 blue:200/255.0 alpha:1];
