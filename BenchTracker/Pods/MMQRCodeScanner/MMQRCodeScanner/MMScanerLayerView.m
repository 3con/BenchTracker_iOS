...
@implementation MMScanerLayerView
...
- (void)layoutSubviews
{
    ...
    {
        UIImage *image = nil;
        if (_qrScanLineImageName) {
            image = [UIImage imageNamed:_qrScanLineImageName];
        } else {
            image = [UIImage imageNamed:@"scan_line"];
        }
...
- (void)scanQrCode
{
    [UIView animateWithDuration:_qrScanLineAnimateDuration
                     animations:^{
